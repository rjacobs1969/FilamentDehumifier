...
static void lcd_set_custom_characters(
  ...
  const static PROGMEM byte rh[8] = {
    B11100,
    B10100,
    B11000,
    B10100,
...
static void lcd_implementation_status_screen() {
  ...
  //
      ...
      updateDHT();  
      lcd.print((char)LCD_STR_THERMOMETER[0]);
      lcd.print(itostr3(DHT_temperature));
      lcd.print((char)LCD_DEGREE_CHAR);
      lcd.print(' ');
      lcd.print((char)LCD_RH_CHAR);
      lcd.print(' ');
      lcd.print(itostr2(DHT_humidity));
      String stringOne =  String("% ");
      lcd.print(stringOne);
      lcd.print((char)LCD_STR_THERMOMETER[0]);
      stringOne =  String("DEW");
      lcd.print(stringOne);
      
      lcd.print(itostr3(DHT_dewPoint));
      lcd.print((char)LCD_DEGREE_CHAR);

      lcd.setCursor(0, 2);
      lcd.print((char)LCD_FEEDRATE_CHAR);
      lcd.print(' ');
      stringOne = String(calculationAbsHum(DHT_temperature, DHT_humidity));//+ " "
      lcd.print(stringOne);
      
      lcd.print(String(" g/m3 "));     
  ...
  //
    ...
    lcd.write('%');
lcd.write(' ');
    stringOne =  String(DHT_temperature);
      lcd.print(stringOne);
